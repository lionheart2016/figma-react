                ...
                <div className="py-1">
                  {networks.map((network) => (
                    <button
                      ...
                      className={`w-full flex items-center space-x-3 px-4 py-2 text-left hover:bg-gray-50 transition-colors duration-150 ${selectedNetwork === network.id ? 'bg-blue-50 text-blue-600' : 'text-gray-700'}`}
                    >
                      <div className="w-6 h-6 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center text-white text-xs font-bold">
                        {network.icon}
                      </div>

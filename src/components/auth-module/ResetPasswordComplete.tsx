            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-[390px] h-[40px] px-3 py-2 bg-white border border-[#73798B] rounded-[6px] text-[14px] font-normal font-poppins placeholder-[#73798B] focus:outline-none focus:border-blue-500"
                />
                <button
                  type="button"

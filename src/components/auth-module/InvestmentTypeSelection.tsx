...
interface InvestmentTypeSelectionProps {
...
const InvestmentTypeSelection: React.FC<InvestmentTypeSelectionProps> = ({ onRegister }) => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`w-full mt-8 py-3 px-6 rounded-lg font-semibold text-sm transition-all duration-200 ${selectedType ? 'bg-[#4B5EF5] text-white hover:bg-[#3A4BD4] active:bg-[#2A3AB3]' : 'bg-[#D9D9D9] text-[#73798B] cursor-not-allowed'}`}
      >

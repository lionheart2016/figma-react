...
var ICONS = {
  add: async () => (await import("./add-3BXR3TSU.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-2BXG5HNF.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-A4OWMF4Q.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-V4BV2NMM.js")).appStoreSvg,
  apple: async () => (await import("./apple-U2JENDNU.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-34LPDDZM.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-CW32WFEE.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NCJTGS7L.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-DS773U3K.js")).arrowTopSvg,
  bank: async () => (await import("./bank-4TJVYFDQ.js")).bankSvg,
  browser: async () => (await import("./browser-IRKPDDC6.js")).browserSvg,
  card: async () => (await import("./card-JFP4UOTB.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-OJJEUZFH.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7UZB3PAY.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-GB6GCNSB.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-DTRA2PR7.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-ZGRK37SI.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-TJDIGT6Q.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-TJVSTQHH.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-INBFGCT2.js")).clockSvg,
  close: async () => (await import("./close-NOITWLNW.js")).closeSvg,
  compass: async () => (await import("./compass-LQBIM6GW.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-MOKJDFHA.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-DZMZWJQ6.js")).copySvg,
  cursor: async () => (await import("./cursor-CXEKCV7G.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-Y44YZ2JI.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-ARFMR66C.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-V2LZ5L3I.js")).disconnectSvg,
  discord: async () => (await import("./discord-BJA7PANI.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-MW7R4ZYU.js")).etherscanSvg,
  extension: async () => (await import("./extension-RGHVGMRJ.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-LLCWMQSP.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-7FNH6M4Q.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-CYVCW6SX.js")).farcasterSvg,
  filters: async () => (await import("./filters-NZDZLMTW.js")).filtersSvg,
  github: async () => (await import("./github-AWBIYNE2.js")).githubSvg,
  google: async () => (await import("./google-E2VREA6W.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-VSI2RIIB.js")).helpCircleSvg,
  image: async () => (await import("./image-45CC6FT3.js")).imageSvg,
  id: async () => (await import("./id-OSKJAV65.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-6N6YFBHN.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-MDFKTXW5.js")).lightbulbSvg,
  mail: async () => (await import("./mail-C6DXLNSZ.js")).mailSvg,
  mobile: async () => (await import("./mobile-CAHZQR4U.js")).mobileSvg,
  more: async () => (await import("./more-HM42FXVD.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-2FG4NPLB.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-DCVCH45W.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-27RJJF3A.js")).offSvg,
  playStore: async () => (await import("./play-store-2G7ADT3O.js")).playStoreSvg,
  plus: async () => (await import("./plus-M73IIAJH.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-TNFJDJQ2.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-IEU6ZMMS.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-JHUMRSV3.js")).refreshSvg,
  search: async () => (await import("./search-R25J2U4B.js")).searchSvg,
  send: async () => (await import("./send-DGRN2ONW.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-E6CVA4K7.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-RXNW6QIH.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-3QRGM2EF.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-INY63CRF.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-44MZYNVO.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-2D5ILTZK.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-FX5CULBZ.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-MGGS4T4U.js")).twitchSvg,
  twitter: async () => (await import("./x-2GNQXJUD.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-3XRN3NTM.js")).twitterIconSvg,
  verify: async () => (await import("./verify-X7QJTEYN.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-HORLMIC5.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-VE2D4JUZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-T6HMLDCS.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-T6HMLDCS.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-T6HMLDCS.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-XAKE737S.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-MSDYBEZD.js")).warningCircleSvg,
  x: async () => (await import("./x-2GNQXJUD.js")).xSvg,
  info: async () => (await import("./info-B33PPEMN.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-NFWZYEI2.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-CI55ATAQ.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2UQVILPV.js.map

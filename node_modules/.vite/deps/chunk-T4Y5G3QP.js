...
import {
  ...
  require_cjs3,
  require_events
} from "./chunk-6H35JEFG.js";
import {
  formatUnits
} from "./chunk-AI6JS3BP.js";
import {
  HashMD
} from "./chunk-3LAE4C6P.js";
import {
  rotl,
  wrapConstructor
...
var SHA1 = class extends HashMD2 {
  ...
  process(view, offset) {
    ...
    for (let i3 = 0; i3 < 80; i3++) {
      ...
      const T = rotl2(A2, 5) + F2 + E2 + K3 + SHA1_W[i3] | 0;
      E2 = D;
      D = C4;
      C4 = rotl2(B3, 30);
      B3 = A2;
...
var shiftsL160 = idxL2.map((idx, i3) => idx.map((j) => shifts160[i3][j]));
var shiftsR160 = idxR2.map((idx, i3) => idx.map((j) => shifts160[i3][j]));
...
var RIPEMD1602 = class extends HashMD2 {
  ...
  process(view, offset) {
    ...
    for (let group = 0; group < 5; group++) {
      ...
      for (let i3 = 0; i3 < 16; i3++) {
        const tr3 = rotl2(ar2 + ripemd_f(rGroup, br2, cr2, dr3) + BUF_160[rr3[i3]] + hbr, sr2[i3]) + er3 | 0;
...
var SHA3_ROTL = [];
var _SHA3_IOTA = [];
for (let round2 = 0, R3 = _1n2, x = 1, y4 = 0; round2 < 24; round2++) {
  [x, y4] = [y4, (2 * x + 3 * y4) % 5];
...
function Ac(t2) {
  ...
  function a(p) {
    ...
    return m2 && (N = X(N, O2)), ft("private key", N, K2, O2), N;
  }
  function u2(p) {
  ...
  class h4 {
    ...
    multiplyAndAddUnsafe(d2, v, m2) {
      const O2 = h4.BASE, N = (B3, A2) => A2 === dt || A2 === K2 || !B3.equals(O2) ? B3.multiplyUnsafe(A2) : B3.multiply(A2), $ = N(this, v).add(N(d2, m2));
      return $.is0() ? void 0 : $;
    }
    toAffine(d2) {
      return l3(this, d2);
    ...
    clearCofactor() {
      ...
      return d2 === K2 ? this : v ? v(h4, this) : this.multiplyUnsafe(e2.h);
    }
    toRawBytes(d2 = true) {
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a, normPrivateKeyToScalar: u2, weierstrassEquation: l3, isWithinCurveOrder: f6 } = Ac({ ...e2, toBytes(g, w, b) {
    ...
    if (w === o2 && (b === 2 || b === 3)) {
      const R3 = Ot(I2);
      if (!Ee(R3, K2, n2.ORDER)) throw new Error("Point is not on curve");
      const x = l3(R3);
      let C4;
      try {
        C4 = n2.sqrt(x);
  ...
  function S2(g, w, b = L) {
    ...
    function st2(W) {
      ...
      if (Zt === dt) return;
      let Ut = (zt.x === vt ? 0 : 2) | Number(zt.y & K2), vn2 = Zt;
...
function rr2(r2, e2) {
  ...
  function d2(u2) {
    ...
    for (var j = (D - I2) * l3 + 1 >>> 0, T = new Uint8Array(j); I2 !== D; ) {
      for (var q2 = u2[I2], J2 = 0, K3 = j - 1; (q2 !== 0 || J2 < x) && K3 !== -1; K3--, J2++) q2 += 256 * T[K3] >>> 0, T[K3] = q2 % a >>> 0, q2 = q2 / a >>> 0;
  ...
  function g(u2) {
    ...
    if (u2[b] !== " ") {
      ...
      if (u2[b] !== " ") {
        ...
        for (var H2 = new Uint8Array(x + (D - K3)), me2 = x; K3 !== D; ) H2[me2++] = j[K3++];
        return H2;
      }
    }
  }
...
@walletconnect/utils/dist/index.es.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-T4Y5G3QP.js.map

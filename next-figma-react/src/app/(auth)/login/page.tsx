...
import PasswordInput from '@/components/auth-module/PasswordInput';
import EmailNotRegisteredModal from '@/components/auth-module/EmailNotRegisteredModal';
...
const Login: React.FC = () => {
  ...
  const handleRegister = () => {
    router.push('/investment-selection');
  };

...
const CompletePage: React.FC = () => {
  ...
  const steps: StepData[] = [
    { id: 'info', title: 'Basic Information', status: 'completed' },
    { id: 'address', title: 'Address Information', status: 'completed' },
    { id: 'party', title: 'Key Parties', status: 'completed' },
    { id: 'document', title: 'Document Upload', status: 'completed' },
    { id: 'complete', title: 'Complete', status: 'current' }
  ];
  ...
  return (
    <Layout 
      ...
      subtitle="Complete"
    >
      <CompletionPage onComplete={handleComplete} />
    </Layout>
  );
};

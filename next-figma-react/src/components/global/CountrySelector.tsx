...
const CountrySelector: React.FC<CountrySelectorProps> = ({
  ...
  return (
    <div className="relative">
      <label className="block text-sm font-medium mb-2 text-[#1C1C1C] dark:text-white">
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-expanded={open}
            className={cn(
              "w-full justify-between border-[#EDEEF3] bg-white text-[#1C1C1C] hover:bg-gray-50 dark:bg-[#1A1A1A] dark:border-[#2C2C2C] dark:text-white dark:hover:bg-[#2C2C2C]",
